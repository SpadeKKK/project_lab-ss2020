# function to export ggplots with defined panel size
# source: egg package 0.2.0, https://stackoverflow.com/a/30571289
set_panel_size <- function (p = NULL, g = ggplot2::ggplotGrob(p), file = NULL,
          margin = unit(1, "mm"), width = unit(4, "cm"), height = unit(4, "cm"))
{
